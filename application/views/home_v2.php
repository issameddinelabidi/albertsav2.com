<?php
/*
<div class="modal fade" id="promo_modal" tabindex="-1" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content text-center">
            <div class="modal-body">
                <button class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>

                <h3>🎁 Profitez de 1 MOIS GRATUIT</h3>
                <p class="mb-6">Gagnez du temps avant la saison estivale :<br>Découvrez la puissance d'Albert SAV et simplifiez votre gestion dès aujourd'hui.</p>

                <p class="mb-1">✅ 1 mois gratuit avec le code : GRATUIT</p>
                <p class="mb-6">✅ Sans engagement, juste des résultats !</p>

                <p class="mb-6">Testez-le dès maintenant et optimisez vos processus avant le rush !</p>


                <a href="<?= site_url('nos-offres#pricing'); ?>" class="btn btn-dark text-light">👉 Je profite de mon mois offert</a>
            </div>
        </div>
    </div>
</div>
...
<section class="wrapper image-wrapper bg-image angled bg-overlay text-white" data-image-src="./assets/img/photos/bg1.jpg">
    ...
    <div class="container py-10">
        <div class="row gx-lg-8 gy-5 gy-lg-0 mb-2 align-items-end">
            <div class="col-lg-4 wow fadeInLeft text-center text-md-left">
                ...
                <h3 class="display-4 mb-0 text-white">Pionnier dans le SAV spécialisé depuis 3 ans.</h3>
...
<section class="wrapper bg-light">
    ...
    <div class="container">
        <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center mb-14 mb-17">
            ...
            <div class="col-md-4">
                <a href="#!" class="btn btn-primary w-100 py-1 mb-0"><span class="display-5 my-0 me-2"><?= APPUP::getFlag('FR'); ?></span> <?= ALBERT_NUMERO_FRANCAIS; ?></a>
            </div>
            <div class="col-md-4">
                <a href="#!" class="btn btn-primary w-100 py-1 mb-0"><span class="display-5 my-0 me-2"><?= APPUP::getFlag('BE'); ?></span> <?= ALBERT_NUMERO_BELGE; ?></a>
            </div>
            <div class="col-md-4">
                <a href="#!" class="btn btn-primary w-100 py-1 mb-0"><span class="display-5 my-0 me-2"><?= APPUP::getFlag('CH'); ?></span> <?= ALBERT_NUMERO_SUISSE; ?></a>
            </div>
        </div>
    </div>
</section>
