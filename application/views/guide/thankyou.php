	...
	<div class="content-wrapper">
		<section class="wrapper"style="height: 100%">
			...
			<section class="wrapper">
				<div class="container py-14 py-md-10 px-5 pt-5 text-dark text-center">
					<h1 class="mt-10 text-success"><i class="fa fa-check"></i></h1>
					<h2 class="text-dark text-center mt-5 pt-5 mb-5"><?= ALBERT_MERCI_DAVOIR_CHOISI_NOTRE_LOGEMENT_POUR_VOTRE_SEJO; ?></h2>

					<h4 class="text-dark text-center mb-4"><?= ALBERT_NOUS_ESPERONS_QUE_VOUS_AVEZ_APPRECIE_VOTRE_SEJOUR; ?></h4>

					<h4 class="text-dark text-center"><?= ALBERT_NOUS_VOUS_SOUHAITONS_UNE_MERVEILLEUSE_CONTINUATION; ?></h4>
				</div>
			</section>
		</section>
	</div>
