        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="job-list mb-10">
                    ...
                    <p>Les évènements de vos annonces.</p>
                    <?php
                    if (empty($tickets)) {
                    ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    if ($ticket['type'] == 'guide') {
                                                        $ticket['traveller_number'] = '<em class="text-muted">depuis Guide Albert</em>';
                                                    }
                                                    ?>

                                                    <h4 class="mb-1"><?= $ticket['name']; ?> - <?= $ticket['traveller_number']; ?></h4>
