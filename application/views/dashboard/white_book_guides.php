        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="job-list mb-10">
                    ...
                    <p>Les <strong>200 derniers évènements</strong> liés à vos <strong class="text-info">annonces séjours</strong></p>
                    <?php
                    if (empty($guides)) {
                    ?>
                                ...
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="mb-0"><a href="<?= site_url('annonce/' . $ticket['annonce_unique_id']); ?>"><?= $ticket['title']; ?></a></h5>
                                                </div>
                                                <div class="col-auto">
                                                    <?php
                                        ...
                                        <div class="card-body py-4">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h4 class="mb-1"><?= $ticket['name']; ?> - <?= $ticket['type']; ?></h4>
                                                    <blockquote><?= $ticket['comment'] ?? ''; ?></blockquote>
                                                    <p>Note du ménage :
                                                        <?php
                                                        if (!empty($ticket['cleaning_rate'])) {
                                                            for ($i = 1; $i <= $ticket['cleaning_rate']; $i++) {
                                                        ?>
                                                                <i class="fa fa-star text-info me-1"></i>
                                                            <?php
                                                            }

                                                            for ($i = $ticket['cleaning_rate'] + 1; $i <= 5; $i++) {
                                                            ?>
