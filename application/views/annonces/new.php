        ...
        <div class="row">
            <div class="col-md-12">
                <div class="job-list mb-10">
                    ...
                    <h3 class="display-3 mb-4 text-center"><?= ALBERT_CREER_UNE_ANNONCE; ?></h3>

                    <form action="<?= site_url('annonces/add'); ?>" method="POST" enctype="multipart/form-data" id="upload_form_full">
                            ...
                            <div class="card-body py-5">
                                <h4 class="mb-3"><?= ALBERT_A_PROPOS_DE_VOTRE_LOGEMENT; ?> :</h3>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" placeholder="Albert" maxlength="190" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="aprobation_rules"><strong><?= ALBERT_REGLES_DAPPROBATION_DE_RESERVATION; ?></strong></label>
                                        <textarea id="aprobation_rules" name="aprobation_rules" class="form-control" placeholder=""></textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" id="sav_type" name="sav_type" required>
                                            ...
                                            <option value="happy"><?= ALBERT_JOVIAL; ?></option>
                                            <option value="strict"><?= ALBERT_STRICT; ?></option>
                                        </select>
                                    </div>

                                    <div class="mb-4">
                                        <label for="type"><strong><?= ALBERT_EST_CE_UNE_MAISON_OU_UN_APPARTEMENT; ?><?= $red_star; ?></strong></label>
                                        <select class="form-select" id="type" name="type" required>
                                            <option selected="" disabled="" value=""><?= ALBERT_SELECTIONNEZ; ?></option>
                                            <option value="house"><?= ALBERT_MAISON; ?></option>
                                            <option value="flat"><?= ALBERT_APPARTEMENT; ?></option>
                                        </select>
                                    </div>

                                    <div class="mb-4">
                                        <label for="address"><strong><?= ALBERT_RUE; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="address" id="address" class="form-control" maxlength="190" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="zipcode" id="zipcode" class="form-control" maxlength="190" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label for="city"><strong><?= ALBERT_VILLE; ?><?= $red_star; ?></strong></label>
                                                <input type="text" name="city" id="city" class="form-control" maxlength="190" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label for="country"><strong><?= ALBERT_PAYS; ?><?= $red_star; ?></strong></label>
                                                <input type="text" name="country" id="country" class="form-control" maxlength="190" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="floor" id="floor" class="form-control" maxlength="3" required>
                                    </div>

                                    <div class="row">
                                        <div class="mb-4 col-md-6">
                                            <label for="building_code"><strong><?= ALBERT_CODE_IMMEUBLE; ?></strong></label>
                                            <input type="text" name="building_code" id="building_code" maxlength="190" class="form-control">
                                        </div>

                                        <div class="mb-4 col-md-6">
                                            <label for="key_box_code"><strong><?= ALBERT_CODE_LOGEMENT_BOITE_A_CLEF; ?></strong></label>
                                            <input type="text" name="key_box_code" id="key_box_code" maxlength="190" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" id="is_elevator" name="is_elevator" required>
                                            <option selected="" disabled="" value=""><?= ALBERT_SELECTIONNEZ; ?></option>
                                            <option value="1"><?= ALBERT_OUI; ?></option>
                                            <option value="0"><?= ALBERT_NON; ?></option>
                                        </select>
                                    </div>

                                    <div class="mb-4">
                                        <label for="nb_couchages"><strong><?= ALBERT_COMBIEN_DE_COUCHAGES_A_VOTRE_LOGEMENT; ?><?= $red_star; ?></strong></label>
                                        <input type="number" name="nb_couchages" id="nb_couchages" class="form-control" maxlength="3" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        ?>
                                            <p class="mb-0"><input type="checkbox" name="equipements[]" class="form-check-input <?= $is_other; ?>" id="equipements_<?= $eq['id']; ?>" value="<?= $eq['id']; ?>" data-div="<?= $is_other_div; ?>"> <label for="equipements_<?= $eq['id']; ?>"><?= $eq['name']; ?></p>
                                        <?php
                                        }
                                        ?>
                                    </div>

                                    <div class="mb-4 d-none" id="is_other_equipement_div">
                                        <label for="is_other_equipement"><strong><?= ALBERT_PRECISEZ; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="is_other_equipement" id="is_other_equipement" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="is_other_poi_around_div">
                                        ...
                                        <input type="text" name="is_other_poi_around" id="is_other_poi_around" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="is_other_tv_more_chanels_div">
                                        ...
                                        <input type="text" name="is_other_tv_more_chanels" id="is_other_tv_more_chanels" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-4 d-none" id="bike_room_details_div">
                                            <label for="bike_room_details"><strong>Lien obligatoire avec indication pour visualiser le local à vélo<?= $red_star; ?></strong></label>
                                            <input type="text" name="bike_room_details" id="bike_room_details" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="is_other_nego_price_div">
                                        ...
                                        <input type="text" name="is_other_nego_price" id="is_other_nego_price" class="form-control" maxlength="190">
                                    </div>

                                    <div class="mb-4">
                                        <label for="average_ttt"><strong>Temps de trajet aux moyens de transports les plus proches</strong></label>
                                        <input type="text" name="average_ttt" id="average_ttt" class="form-control" placeholder="<?= ALBERT_PRECISEZ; ?>" maxlength="190">
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body py-5">
                                <h4 class="mb-3"><?= ALBERT_ACTIVITE_OPERATIONNELLE; ?> :</h3>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="arrival_hour" id="arrival_hour" class="form-control" maxlength="190" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="leaving_hour"><strong><?= ALBERT_QUELLE_EST_LHEURE_DE_DEPART; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="leaving_hour" id="leaving_hour" class="form-control" maxlength="190" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4 d-none" id="early_check_rules_div">
                                                <label for="early_check_rules"><strong><?= ALBERT_SI_OUI_QUELLES_SONT_LES_REGLES_DU_CHECK_IN; ?></strong></label>
                                                <input type="text" name="early_check_rules" id="early_check_rules" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4 d-none" id="late_check_rules_div">
                                                <label for="late_check_rules"><strong><?= ALBERT_SI_OUI_QUELLES_SONT_LES_REGLES_DU_CHECK_OUT; ?></strong></label>
                                                <input type="text" name="late_check_rules" id="late_check_rules" class="form-control" maxlength="190">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-none" id="caution_infos_div">
                                        <div class="mb-4">
                                            <label for="deposit_rules"><strong><?= ALBERT_SI_OUI_DETAILS_CONCERNANT_LE_VERSEMENT_DE_LA_CAUTI; ?></strong></label>
                                            <input type="text" name="deposit_rules" id="deposit_rules" class="form-control" maxlength="190">
                                        </div>

                                        <div class="mb-4">
                                            <label for="deposit_refund"><strong><?= ALBERT_SI_OUI_QUAND_LA_CAUTION_SERA_RESTITUEE; ?></strong></label>
                                            <input type="text" name="deposit_refund" id="deposit_refund" class="form-control" maxlength="190">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        ?>
                                            <p class="mb-0"><input type="checkbox" name="consommables[]" class="form-check-input <?= $is_other; ?>" id="consommable_<?= $cons['id']; ?>" value="<?= $cons['id']; ?>" data-div="<?= $is_other_div; ?>"> <label for="consommable_<?= $cons['id']; ?>"><?= $cons['name']; ?></p>
                                        <?php
                                        }
                                        ?>
                                    </div>

                                    <div class="mb-4 d-none" id="is_other_consommable_div">
                                        <label for="is_other_consommable"><strong><?= ALBERT_PRECISEZ; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="is_other_consommable" id="is_other_consommable" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        foreach ($coffe_list as $coff) {
                                            ...
                                            $radio_required = ($radio_counter == 0) ? 'required' : '';
                                        ?>
                                            <p class="mb-0"><input type="radio" name="coffe_type[]" class="form-check-input radio_coffe_check <?= $is_other; ?>" id="coffe_<?= $coff['id']; ?>" value="<?= $coff['id']; ?>" data-div="<?= $is_other_div; ?>" <?= $radio_required; ?>> <label for="coffe_<?= $coff['id']; ?>"><?= $coff['name']; ?></p>
                                        <?php
                                            $radio_counter++;
                                        }
                                        ?>
                                    ...
                                    <div class="mb-4 d-none" id="is_other_coffe_type_div">
                                        ...
                                        <input type="text" name="is_other_coffe_type" id="is_other_coffe_type" class="form-control" maxlength="190">
                                    </div>

                                    <div class="mb-4">
                                        <label for="is_other_coffe_type"><strong><?= ALBERT_TYPE_DE_CHAUFFAGE; ?></strong></label>
                                        <input type="text" name="heater_type" class="form-control" placeholder="<?= ALBERT_TYPE_DE_CHAUFFAGE; ?>" maxlength="190">
                                    </div>

                                    <div class="mb-4">
                                        <label for="is_other_coffe_type"><strong><?= ALBERT_FONCTIONNEMENT_DU_CHAUFFAGE; ?></strong></label>
                                        <input type="text" name="heater_tips" class="form-control" placeholder="<?= ALBERT_FONCTIONNEMENT_DU_CHAUFFAGE; ?>" maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select yes_no_listener" id="extra_prestations" name="extra_prestations" data-div="extra_prestations_details_div" required="">
                                            <option value=""><?= ALBERT_SELECTIONNEZ; ?></option>
                                            <option value="1"><?= ALBERT_OUI; ?></option>
                                            <option value="0"><?= ALBERT_NON; ?></option>
                                        </select>
                                    </div>

                                    <div class="mb-4 d-none" id="extra_prestations_details_div">
                                        <label for="extra_prestations_details"><strong><?= ALBERT_SI_OUI_LESQUELLES; ?></strong></label>
                                        <input type="text" name="extra_prestations_details" id="extra_prestations_details" class="form-control" maxlength="190">
                                    </div>

                                    <div class="mb-4">
                                        <label for="shop_link"><strong>Lien vers votre boutique</strong></label>
                                        <input type="text" name="shop_link" id="shop_link" class="form-control" placeholder="https://......" maxlength="190">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        ?>
                                            <p class="mb-0"><input type="checkbox" name="reglements[]" class="form-check-input <?= $is_other; ?>" id="reg_<?= $reg['id']; ?>" value="<?= $reg['id']; ?>" data-div="<?= $is_other_div; ?>"> <label for="reg_<?= $reg['id']; ?>"><?= $reg['name']; ?></p>
                                        <?php
                                        }
                                        ?>
                                    </div>

                                    <div class="mb-4 d-none" id="is_other_reglement_div">
                                        <label for="is_other_reglement"><strong><?= ALBERT_PRECISEZ; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="is_other_reglement" id="is_other_reglement" class="form-control" maxlength="190">
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="booking_link" id="booking_link" class="form-control" placeholder="Lien booking" maxlength="190">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="airbnb_link" id="airbnb_link" class="form-control" placeholder="Lien airbnb" maxlength="190" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="leboncoin_link" id="leboncoin_link" class="form-control" placeholder="Lien leboncoin" maxlength="190">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" name="abritel_link" id="abritel_link" class="form-control" placeholder="Lien abritel" maxlength="190">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="minimum_travel_duration" id="minimum_travel_duration" class="form-control" maxlength="3" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="maximum_travel_duration"><strong><?= ALBERT_QUELLE_EST_LA_DUREE_MAXIMUM_DE_SEJOUR; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="maximum_travel_duration" id="maximum_travel_duration" class="form-control" maxlength="3" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="limit_reservation_hour_same_day" id="limit_reservation_hour_same_day" class="form-control" required maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="month_reservation_average" id="month_reservation_average" class="form-control" maxlength="3" required>
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="automatic_message_reception_div">
                                        <label for="automatic_message_reception"><strong><?= ALBERT_SI_OUI_QUAND_EST_CE_QUE_LE_VOYAGEUR_LE_RECOIT; ?></strong></label>
                                        <textarea name="automatic_message_reception" id="automatic_message_reception" class="form-control" rows="2"></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="is_self_entry"><strong><?= ALBERT_LENTREE_EST_ELLE_AUTONOME; ?><?= $red_star; ?></strong></label>
                                        <p class="small mb-0">Vous pourrez gérer votre procédure d'entrée et de sortie après création de l'annonce</p>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="guide_link" id="guide_link" class="form-control" rows="3"></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="entry_guide_link"><strong>Infos complémentaires guide<?= $red_star; ?></strong></label>
                                        <textarea name="entry_guide_link" id="entry_guide_link" class="form-control" rows="5" required></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="video_check_in"><strong>Vidéo du check-in</strong></label>
                                        <input type="text" name="video_check_in" id="video_check_in" class="form-control" placeholder="Renseignez le lien d'une vidéo de votre check-in" maxlength="190"></textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="refund_political_link" id="refund_political_link" class="form-control" required maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="parking_possibilities" id="parking_possibilities" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="d-none" id="wifi_zone_div">
                                        <div class="row">
                                            <div class="mb-4 col-md-6">
                                                <label for="wifi_user"><strong><?= ALBERT_IDENTIFIANT_WIFI; ?></strong></label>
                                                <input type="text" name="wifi_user" id="wifi_user" maxlength="190" class="form-control">
                                            </div>

                                            <div class="mb-4 col-md-6">
                                                <label for="wifi_password"><strong><?= ALBERT_MOT_DE_PASSE_WIFI; ?></strong></label>
                                                <input type="text" name="wifi_password" id="wifi_password" maxlength="190" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-12">
                                        ...
                                        <select class="form-select" id="have_fan" name="have_fan" required>
                                            <option selected="" disabled="" value=""><?= ALBERT_SELECTIONNEZ; ?></option>
                                            <option value="1"><?= ALBERT_OUI; ?></option>
                                            <option value="0"><?= ALBERT_NON; ?></option>
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select yes_no_listener is_other" id="have_clim" name="have_clim" data-div="is_other_clim" required>
                                            <option selected="" disabled="" value=""><?= ALBERT_SELECTIONNEZ; ?></option>
                                            <option value="1"><?= ALBERT_OUI; ?></option>
                                            <option value="0"><?= ALBERT_NON; ?></option>
                                        </select>
                                    ...
                                    <div class="d-none" id="is_other_clim_div">
                                        <div class="row">
                                            <div class="mb-4 col-md-12">
                                                <label for="is_other_clim"><strong><?= ALBERT_PRECISEZ; ?></strong></label>
                                                <input type="text" name="is_other_clim" id="is_other_clim" maxlength="190" placeholder="Précisez" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-none" id="have_electric_dash_zone_div">
                                        <div class="row">
                                            <div class="mb-4 col-md-12">
                                                ...
                                                <input type="text" name="is_other_electric_dash" id="have_electric_dash_div" maxlength="190" placeholder="Précisez" class="form-control" maxlength="190">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="tv_code_div">
                                        <label for="tv_code"><strong><?= ALBERT_SI_OUI_QUEL_EST_LE_CODE; ?></strong></label>
                                        <input type="text" name="tv_code" id="tv_code" maxlength="190" class="form-control" maxlength="190">
                                    </div>
                                    ...
                                    <div class="mb-4 d-none" id="bags_deposit_rules_div">
                                        <label for="bags_deposit_rules"><strong><?= ALBERT_SI_OUI_LIEN_DE_LA_CONSIGNE; ?></strong></label>
                                        <input type="text" name="bags_deposit_rules" id="bags_deposit_rules" class="form-control" maxlength="190">
                                    </div>


                                    <div class="mb-4">
                                        <label for="trash_location"><strong><?= ALBERT_OU_LES_VOYAGEURS_DOIVENT_ILS_JETER_LES_POUBELLES; ?><?= $red_star; ?></strong></label>
                                        <input type="text" name="trash_location" id="trash_location" class="form-control" required maxlength="190">
                                    </div>

                                    <div class="mb-4">
                                        <label for="other_points"><strong><?= ALBERT_Y_A_TIL_DAUTRES_POINTS_A_CONNAITRE_OUVERTURE_DE_PO; ?><?= $red_star; ?></strong></label>
                                        <textarea name="other_points" id="other_points" class="form-control" rows="5" required></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="recurring_answers"><strong>Réponses récurrentes</strong></label>
                                        <textarea name="recurring_answers" id="recurring_answers" class="form-control" rows="5"></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="free_note"><strong><?= ALBERT_NOTE_LIBRE; ?></strong></label>
                                        <textarea name="free_note" id="free_note" class="form-control" rows="5"></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="other_points"><strong><?= ALBERT_PHOTOS_DU_LOGEMENT; ?><?= $red_star; ?></strong></label>
                        ...
                        <div class="card card-border-start border-dark mb-5">
                            <div class="card-body py-5">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <input type="range" id="autonomy_value" name="autonomy_value" class="form-range" steps="1" min="1" max="4" value="1" oninput="this.nextElementSibling.value = this.value" required>

                                    </div>
                                    <div class="col-md-6">
                                        <p id="answer_1" class="autonomy_answers d-block"><span class="display-6 me-2">1</span>Aucune autonomie, vous pouvez me déranger régulièrement.</p>
                                        <p id="answer_2" class="autonomy_answers d-none"><span class="display-6 me-2">2</span>Utilisation des fiches + me demander si besoin.</p>
                                        <p id="answer_3" class="autonomy_answers d-none"><span class="display-6 me-2">3</span>Prise d'initiatives régulières, début de l'autonomie.</p>
                                        <p id="answer_4" class="autonomy_answers d-none"><span class="display-6 me-2">4</span>Les agents sont libres de chaque décision et se basent sur les informations fournies dans la fiche logement.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <button type="submit" class="btn btn-gradient gradient-7 w-100" id="add_annonce_button" onclick="return confirm('<?= ALBERT_CONFIRMEZ_VOUS_LA_CREATION_DE_VOTRE_ANNONCE; ?>')"><?= ALBERT_CREER_LANNONCE; ?></button>
                        </div>
...
<script>
    // Sauvegarder les données dans localStorage quand un champ change
    document.querySelectorAll('#upload_form_full input, #upload_form_full textarea').forEach(function(element) {
